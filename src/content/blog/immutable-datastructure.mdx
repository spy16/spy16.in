...
import afterImbl from "./after-imbl.png";
import beforeImbl from "./before-imbl.png";
...
See the before and after latency profiles.

<Image src={beforeImbl} alt="Before" class="h-[400px] w-full" />
<Image src={afterImbl} alt="After" class="h-[400px] w-full" />
